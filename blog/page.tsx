          ...
          <div className="w3-justify">
            ...
            >
              ...
              <div className="w3-col l2 m3">
                <img src="/w3images/avatar_smoke.jpg" style={{ width: 90 }} />
              </div>
          ...
          <div className="w3-justify">
            ...
            <div id="demo2" style={{ display: "none" }}>
              <div className="w3-row">
                <hr />
                <div className="w3-col l2 m3">
                  <img src="/w3images/girl_train.jpg" style={{ width: 90 }} />
                </div>
                <div className="w3-col l10 m9">
                  <h4>
                    Amber{" "}
              ...
              <div className="w3-row w3-margin-bottom">
                <div className="w3-col l2 m3">
                  <img src="/w3images/girl.jpg" style={{ width: 90 }} />
                </div>
                <div className="w3-col l10 m9">
                  <h4>
                    Angie{" "}
          ...
          <div className="w3-justify">
            ...
            <div id="demo3" style={{ display: "none" }}>
              ...
              <div className="w3-row w3-margin-bottom">
                <div className="w3-col l2 m3">
                  <img
                    src="/w3images/girl_mountain.jpg"
                    style={{ width: 90 }}
                  />
                </div>
                <div className="w3-col l10 m9">
              ...
              <div className="w3-row w3-margin-bottom">
                <div className="w3-col l2 m3">
                  <img src="/w3images/boy.jpg" style={{ width: 90 }} />
                </div>
                <div className="w3-col l10 m9">
                  <h4>
                    John{" "}
